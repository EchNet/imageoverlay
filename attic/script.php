...
#####
$ImageURL = "https://oeminteractive.com/imageoverlay/images/$imagename.jpg";
...
# Font color in Hex
//$fontcolor1 = '6D2EFF'; # FFFFFF white
...
if($no_output == 1) {
	...
	Image Template:<br>
<select name=\"imagename\" class=\"wpcf7-form-control wpcf7-text wpcf7-validates-as-required\" style=\"height:44px;margin-right:10px;padding-left:5px;width:389px;\">
	<option value=\"$imagename\">$imagename</option>";
	
	if ($imagename !== "Ford"){echo"<option value=\"Ford\">Ford</option>";}
	if ($imagename !== "Honda"){echo "<option value=\"Honda\">Honda</option>";}
   	if ($imagename !== "Polaris"){echo "<option value=\"Polaris\">Polaris</option>";}
...
<input type=\"number\" name=\"fontsize1\" value=\"$fontsize1\" size=\"50\" class=\"wpcf7-form-control wpcf7-text wpcf7-validates-as-required\" aria-required=\"true\" 	aria-invalid=\"false\" placeholder=\"Font Size (8-100)\" style=\"height:44px;margin-right:10px;padding-left:5px;width:389px;\" min=8 max=100><br><br>
	...
	<button id=\"submit_btn\" type=\"submit\" class=\"wpcf7-form-control wpcf7-submit\" name=\"submit\" style=\"display:inline-block;width:150px;height:44px;float:right;margin-right:22px\">Update Image</button>
